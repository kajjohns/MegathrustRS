function [out, serr] = ratestate_3D_dilatancy(t,x,srate,d_c,A,sigma,eta,c_star,eps,beta,pinf,mu,nps,a_b_slope,logVcut,use_ikari)
...
dtau_dt = hm_mvp('mvp',gamb.hmat.id,v) + srate;
