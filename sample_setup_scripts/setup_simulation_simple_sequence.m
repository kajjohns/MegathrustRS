...
param_depth(4) = 20; 
param_depth(5) = 23;
param_depth(6) = -FaultPatches(end,4);  % bottom edge (required, set to bottom edge of interface) 
...
pore_pressure_fraction(1) = 0.85;
pore_pressure_fraction(2) = 0.85;
pore_pressure_fraction(3) = 0.85;
pore_pressure_fraction(4) = 0.85;
pore_pressure_fraction(5) = 0.85;
pore_pressure_fraction(6) = 0.85;
...
%dilatancy coefficient,  1.7e-4 (Segall and Rice, quartz), Samualsen (4.7e-5 to 3e-4)
eps(1) = 0;  
eps(2) = 0;
eps(3) = 0;  
eps(4) = 0;
