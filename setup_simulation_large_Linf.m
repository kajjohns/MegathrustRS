...
%elastic_name = 'elastic_GFs_medium';
...
pore_pressure_fraction(4) = 0.8;
pore_pressure_fraction(5) = 0.8;
pore_pressure_fraction(6) = 0.8;
pore_pressure_fraction(7) = 0.8;
pore_pressure_fraction(8) = 0.8;
...
mup = 3e10/(1-0.25);
L_inf = b./(pi*(b-a).^2)*mup.*dc./(sigma-pinf);
